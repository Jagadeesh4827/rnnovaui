 ...
 *
 * IMPORTANT:
 * This component DOES NOT add safe-area top padding.
 *
 * UIBannerCarousel owns the status-bar inset.
 *
 * Therefore:
 *
 * Status Bar
...
const UIHomeHeader = ({
  ...
  /**
   * Internal header padding only.
   *
   * Do NOT put insets.top here.
   */
  paddingTop = 0,
